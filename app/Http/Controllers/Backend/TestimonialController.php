...
class TestimonialController extends Controller
{
    ...
    public function index()
    {
        ...
        ->select(['id', 'client_name','client_name_slug', 'client_designation', 'client_message', 'client_image', 'updated_at'])->paginate(15);
    ...
    {
        $testimonial = Testimonial::where('client_name_slug', $slug)->first()->delete();
    ...
    public function image_upload($request, $item_id)
    {
        ...
        if ($request->hasFile('client_image')) {
            ...
            Image::make($uploaded_photo)->resize(110,110)->save(base_path($new_photo_location), 40);
